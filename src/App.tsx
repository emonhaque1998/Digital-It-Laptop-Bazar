...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC] flex flex-col font-sans selection:bg-blue-600 selection:text-white">
      ...
      {/* Main Catalog View */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-1 w-full space-y-6">
        {/* Results Header & Sorting Bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-[#1E293B] p-5 rounded-2xl border border-slate-800 shadow-md">
          <div>
            <div className="flex items-center gap-2.5">
              <h2 className="text-lg sm:text-xl font-black text-[#F8FAFC] uppercase tracking-wide">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
            ...
            <button
              ...
              className="lg:hidden px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-[#F8FAFC] border border-slate-700 text-xs font-extrabold uppercase tracking-wide flex items-center gap-1.5"
            >
              <Filter className="w-3.5 h-3.5 text-blue-400" />
              <span>Filter ({filters.brand === 'ALL' ? 'All' : filters.brand})</span>
            </button>
            ...
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-slate-300">
              ...
              <select
                ...
                className="px-3 py-2 rounded-xl border border-slate-700 bg-[#0F172A] text-[#F8FAFC] text-xs font-extrabold focus:outline-hidden focus:ring-2 focus:ring-blue-500"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-9">
            {sortedLaptops.length === 0 ? (
              <div className="bg-[#1E293B] rounded-3xl border border-slate-800 p-12 text-center space-y-4">
                <div className="w-16 h-16 rounded-full bg-slate-800 flex items-center justify-center mx-auto text-slate-400">
                  <Search className="w-8 h-8" />
                </div>
                <h3 className="text-lg font-black text-[#F8FAFC] uppercase tracking-wide">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-black uppercase tracking-wide"
                >
                  Reset All Filters
                </button>
              </div>
      ...
      {/* Floating WhatsApp Hotline Button (Bottom Right) */}
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-2.5 items-end">
        {comparedLaptopIds.length > 0 && (
          <button
            onClick={() => setIsComparisonOpen(true)}
            className="px-4 py-2 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-black uppercase tracking-wide flex items-center gap-2 shadow-2xl border border-blue-400/50 cursor-pointer animate-bounce"
          >
        ...
        <a
          ...
          className="p-3.5 bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white rounded-full shadow-2xl flex items-center gap-2 transition-all hover:scale-105"
